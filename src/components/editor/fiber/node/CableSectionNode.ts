...
export const CableColorCode = ['blue', 'orange', 'green', 'brown', 'gray', 'white', 'red', 'black', 'yellow', 'violet', 'pink', 'aqua'];
...
const CableSectionNode = fabric.util.createClass(fabric.Group, {
    ...
    createCoreContainer(coreContainerNumber: number) {
        return new fabric.Rect({
            ...
            fill: CableColorCode[coreContainerNumber],
        });
    },
    createCore(coreContainerNumber: number, coreNumber: number) {
        return new fabric.Rect({
            ...
            fill: CableColorCode[coreNumber],
            stroke: '#555555',
            strokeWidth: 1,
        });
    },
