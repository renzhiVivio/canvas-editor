...
class AnimationHandler {
    ...
    public resetAnimation = (obj: FabricObject, hasControls = true) => {
        ...
        if (type === 'fade') {
            Object.assign(option, filterObject({
            ...
            if (obj.type === 'svg') {
                (obj as fabric.Group)._objects.forEach(child =>
                    this.handler.setByPartial(child, {
                        ...
                        originFill: undefined,
                        originStroke: undefined,
                    }),
                );
            }
            Object.assign(option, filterObject({
        ...
        const option: anime.AnimeParams = {
            ...
            update: (instance: anime.AnimeInstance) => {
                if (type === 'flash') {
                    ...
                    console.error(instance.animations[0], 'instance.animations[0] undefined.');
                    console.error(instance.animations[1], 'instance.animations[1] undefined.');
